function [ x_kalm_k1, P_kalm_k1, weight_k1, n_k1] = filtre_de_kalman( F, Q, H, R, y_k,x_kalm_k, P_kalm_k,n_k,weight_k,ps,pd,lambda,nombre_gaussien_a_garder,threshold,k)
  ...
  for i=1:n_gamma
    l=i;
    x_kalm_k1_k([1 3],l) = 150*rand(2,1)+[250;250];
  ...
  [kalmanToKeep weight] = choosegaussiantokeep (weight_k1,x_kalm_k1,P_kalm_k1,n_k1,threshold,k);
  weight_k1 = weight_k1(kalmanToKeep);
  x_kalm_k1 = x_kalm_k1(:,kalmanToKeep);
  P_kalm_k1 = P_kalm_k1(:,:,kalmanToKeep);
